  ...
  if (!route) {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 py-16 text-center max-w-3xl mx-auto">
        <div className="w-16 h-16 rounded-full bg-[#062448]/10 flex items-center justify-center text-[#062448] mb-4">
          <Compass size={36} />
        </div>
        ...
        <div className="w-full bg-white p-6 rounded-2xl shadow-md border border-[#e5ebe7] mb-8 text-left">
          <h2 className="text-lg font-bold text-[#1a1f1b] mb-4 flex items-center gap-2">
            <Truck size={20} className="text-[#062448]" /> Explore Popular Verified Transport Routes:
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {publishedRoutes.map((r) => (
              <Link
                key={r.slug}
                to={`/${r.slug}`}
                className="p-3 rounded-lg border border-[#e5ebe7] hover:border-[#062448] hover:bg-[#EBF2F9] transition-all flex items-center justify-between group"
              >
                <span className="font-bold text-[#1a1f1b] text-sm group-hover:text-[#062448]">
                  {r.fromCity} → {r.toCity}
                </span>
        ...
        <div className="flex gap-4">
          <Link
            to="/routes"
            className="px-6 py-3 rounded-lg bg-[#062448] text-white font-bold hover:bg-[#0A3366] transition-colors"
          >
            View All Routes
          </Link>
          <Link
            to="/book-truck"
            className="px-6 py-3 rounded-lg bg-[#E9A015] text-[#4A2E00] font-bold hover:bg-[#D08C0A] transition-colors"
          >
            Custom Quote
          </Link>
        </div>
    ...
    <div className="w-full bg-[#ECE6DD] text-[#1a1f1b] overflow-hidden">
      ...
      <nav aria-label="Breadcrumb" className="bg-[#E4DDD3] border-b border-[#d8d0c3] py-2 px-4 md:px-12 text-xs font-['Manrope']">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-neutral-600">
          <Link to="/" className="hover:text-[#062448] transition-colors">Home</Link>
          <span>/</span>
          <Link to="/routes" className="hover:text-[#062448] transition-colors">Routes</Link>
          <span>/</span>
      ...
      <section className="relative pt-10 pb-16 md:pt-14 md:pb-24 px-4 md:px-12 bg-gradient-to-b from-[#E4DDD3] to-[#ECE6DD] border-b border-[#d8d0c3]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-5">
            {/* Corridor badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#062448]/10 text-[#062448] font-['Space_Mono'] text-xs font-bold border border-[#062448]/20">
              <span className="w-2 h-2 rounded-full bg-[#062448] animate-pulse"></span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-2">
              {route.heroHighlights.map((hl, idx) => (
                <div key={idx} className="flex items-center gap-2.5 text-sm font-bold text-neutral-800 font-['Manrope']">
                  <CheckCircle2 size={18} className="text-[#062448] shrink-0" />
                  <span>{hl}</span>
                </div>
              ))}
            </div>
            ...
            <div className="pt-4 flex flex-wrap gap-3.5 items-center">
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#062448] text-white font-['Manrope'] font-bold text-sm uppercase tracking-wider shadow-lg hover:bg-[#0A3366] transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
              >
                <Truck size={18} />
              ...
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-[#E9A015] text-[#4A2E00] font-['Manrope'] font-extrabold text-sm uppercase tracking-wider shadow-md hover:bg-[#D08C0A] transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
              >
              ...
              >
                <Phone size={17} className="text-[#062448]" />
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-[#e2dacd] relative">
              <div className="flex items-center justify-between border-b border-[#ECE6DD] pb-4 mb-4">
                <div className="flex items-center gap-2.5">
                  <div className="p-2 rounded-lg bg-[#062448]/10 text-[#062448]">
                    <Truck size={22} />
                  </div>
                  <div>
                ...
                <span className="px-2.5 py-1 rounded bg-[#EBF2F9] text-[#062448] text-xs font-bold font-['Space_Mono']">
                  VERIFIED
                </span>
              </div>
              ...
              <div className="space-y-3 font-['Manrope'] text-sm">
                ...
                <div className="flex items-center justify-between py-2 border-b border-neutral-100">
                  ...
                  <span className="inline-flex items-center gap-1 font-bold text-[#062448]">
              ...
              <div className="mt-5 pt-4 border-t border-[#ECE6DD]">
                <button
                  onClick={scrollToQuote}
                  className="w-full py-3 rounded-xl bg-[#062448] text-white font-['Manrope'] font-bold text-xs uppercase tracking-wider hover:bg-[#0A3366] transition-colors text-center block"
                >
      ...
      <section className="py-16 px-4 md:px-12 max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#e2dacd]">
          <div className="max-w-3xl mb-8">
            <span className="text-xs font-bold uppercase tracking-wider text-[#062448] font-['Space_Mono'] block mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-neutral-700 font-['Manrope'] leading-relaxed text-sm md:text-base">
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-[#1a1f1b] flex items-center gap-2">
                <MapPin size={18} className="text-[#062448]" /> Corridor Overview & Highway Network
              </h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-[#1a1f1b] flex items-center gap-2">
                <Boxes size={18} className="text-[#062448]" /> Industries & Cargo Demands
              </h3>
      ...
      <section className="py-14 px-4 md:px-12 max-w-7xl mx-auto border-t border-[#d8d0c3]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {[
            ...
            <div
              key={idx}
              className="bg-white rounded-2xl p-5 border border-[#e2dacd] shadow-sm hover:shadow-md transition-all hover:border-[#062448] flex flex-col justify-between"
            >
              <div>
                <span className="text-[10px] font-bold font-['Space_Mono'] px-2 py-0.5 rounded bg-[#062448]/10 text-[#062448] uppercase">
                  {svc.badge}
                </span>
              ...
              <button
                onClick={scrollToQuote}
                className="mt-4 inline-flex items-center gap-1.5 text-xs font-bold text-[#062448] hover:underline"
              >
      ...
      <section className="py-14 px-4 md:px-12 max-w-7xl mx-auto border-t border-[#d8d0c3]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {route.truckTypes.map((truck, idx) => (
            <div
              key={idx}
              className="bg-white rounded-2xl p-5 border border-[#e2dacd] hover:border-[#062448] shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="p-2 rounded-lg bg-[#ECE6DD] text-[#062448]">
                    <Truck size={20} />
                  </div>
                  {truck.tag && (
                    <span className="text-[10px] font-bold font-['Space_Mono'] px-2 py-0.5 rounded bg-[#E9A015]/20 text-[#4A2E00]">
                      {truck.tag}
                    </span>
                  )}
                </div>
              ...
              <button
                ...
                className="mt-5 w-full py-2.5 rounded-lg bg-[#ECE6DD] hover:bg-[#062448] hover:text-white text-[#1a1f1b] font-bold text-xs uppercase tracking-wider font-['Manrope'] transition-all"
              >
                Select & Book
              </button>
            </div>
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 md:p-8 border border-[#e2dacd]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
              {route.industries.map((ind, idx) => (
                <div
                  key={idx}
                  className="p-3 rounded-xl bg-[#fbf9f6] border border-[#ECE6DD] hover:border-[#062448]/50 transition-colors text-xs font-bold text-[#1a1f1b] flex items-center gap-2 font-['Manrope']"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-[#062448]"></span>
                  <span>{ind}</span>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 md:p-8 border border-[#e2dacd]">
            ...
            <div className="flex flex-wrap gap-2">
              {route.materialsTransported.map((mat, idx) => (
                <span
                  key={idx}
                  className="px-3.5 py-2 rounded-xl bg-[#EBF2F9] text-[#062448] text-xs font-bold font-['Manrope'] border border-[#062448]/15 flex items-center gap-1.5"
                >
        ...
        <div className="bg-[#1C201D] text-white rounded-3xl p-6 md:p-12 shadow-2xl relative overflow-hidden">
          <div className="max-w-3xl mb-8">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              {route.rateCardHighlights?.loadCapacityBadge && (
                <span className="px-2.5 py-0.5 rounded-full bg-[#E9A015] text-[#4A2E00] text-[10px] font-extrabold font-['Space_Mono'] uppercase">
                  {route.rateCardHighlights.loadCapacityBadge}
                </span>
              )}
            </div>
            ...
            {route.rateCardHighlights?.panIndiaRate && (
              <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2">
                <div className="p-3 rounded-xl bg-white/10 border border-white/15">
                  ...
                  <span className="text-xl font-bold font-['Space_Mono'] text-[#E9A015]">{route.rateCardHighlights.panIndiaRate.rate19ft}</span>
                </div>
                <div className="p-3 rounded-xl bg-white/10 border border-white/15">
          ...
          <div className="overflow-x-auto mb-8">
            <table className="w-full text-left font-['Manrope'] text-sm">
              <thead>
                <tr className="border-b border-neutral-700 text-xs font-['Space_Mono'] uppercase text-[#E9A015]">
              ...
              <tbody className="divide-y divide-neutral-800">
                {route.priceEstimates.map((item, idx) => (
                  <tr key={idx} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="py-4 pl-4 text-right font-extrabold text-[#E9A015] font-['Space_Mono']">
                      {item.priceRange}
                    </td>
                  </tr>
                ))}
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-5 text-xs text-neutral-300 font-['Manrope'] space-y-2">
            <div className="font-bold text-white uppercase font-['Space_Mono'] flex items-center gap-2">
              <Info size={15} className="text-[#E9A015]" /> Final Rate Determining Factors:
            </div>
          ...
          <div className="mt-8 flex flex-wrap gap-4 items-center justify-between pt-6 border-t border-neutral-800">
            ...
            <button
              onClick={scrollToQuote}
              className="px-6 py-3 rounded-xl bg-[#E9A015] text-[#4A2E00] font-bold text-xs uppercase tracking-wider font-['Manrope'] hover:bg-[#D08C0A] transition-colors"
            >
          ...
          {route.transitSteps.map((step) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <span className="w-9 h-9 rounded-full bg-[#062448] text-white font-['Space_Mono'] font-extrabold text-sm flex items-center justify-center">
                  0{step.step}
                </span>
                {step.expectedTime && (
                  <span className="text-[11px] font-bold font-['Space_Mono'] text-[#062448] bg-[#EBF2F9] px-2.5 py-0.5 rounded-full">
                    {step.expectedTime}
                  </span>
                )}
              </div>
              ...
              {[
                ...
                <div key={idx} className="p-3.5 rounded-xl bg-[#fbf9f6] border border-[#ECE6DD]">
                  <div className="font-bold text-[#1a1f1b] flex items-center gap-2 mb-1">
                    <CheckCircle2 size={16} className="text-[#062448] shrink-0" />
...
-         
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span
                      className={`text-[10px] font-bold font-['Space_Mono'] px-2 py-0.5 rounded ${
                        doc.mandatory ? 'bg-[#062448] text-white' : 'bg-neutral-200 text-neutral-700'
                      }`}
                    >
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left px-5 py-4 flex items-center justify-between font-bold text-sm sm:text-base text-[#1a1f1b] hover:text-[#062448] transition-colors focus:outline-none"
                >
                  <span className="pr-4">{faq.question}</span>
                  {isOpen ? <ChevronUp size={20} className="text-[#062448] shrink-0" /> : <ChevronDown size={20} className="text-neutral-400 shrink-0" />}
                </button>
                {isOpen && (
      ...
      {route.galleryImages && route.galleryImages.length > 0 && (
        <section className="py-14 px-4 md:px-12 max-w-7xl mx-auto border-t border-[#d8d0c3]">
          <div className="space-y-4">
            <span className="text-xs font-bold uppercase tracking-wider text-[#062448] font-['Space_Mono'] block">
              Fleet in Action
            </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              {route.relatedRoutes.map((rel, idx) => (
                <Link
                  key={idx}
                  to={`/${rel.slug}`}
                  className="p-3 rounded-xl border border-[#ECE6DD] hover:border-[#062448] hover:bg-[#EBF2F9] transition-all flex items-center justify-between group font-['Manrope']"
                >
                  <div>
                    <span className="font-bold text-sm text-[#1a1f1b] group-hover:text-[#062448] block">
                      {rel.fromCity} ➔ {rel.toCity}
                    </span>
                    <span className="text-[11px] text-neutral-500 font-['Space_Mono']">{rel.distanceKm} km</span>
                  </div>
                  <span className="text-xs font-bold text-[#062448] font-['Space_Mono']">{rel.transitTime}</span>
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl p-6 md:p-8 border border-[#e2dacd]">
            ...
            <div className="space-y-3 font-['Manrope']">
              {route.blogSuggestions.map((blog, idx) => (
                <div key={idx} className="p-3.5 rounded-xl bg-[#fbf9f6] border border-[#ECE6DD] hover:border-[#062448]/50 transition-colors">
                  <div className="flex items-center justify-between text-[11px] font-['Space_Mono'] text-neutral-500 mb-1">
                    <span className="text-[#062448] font-bold">{blog.category}</span>
                    <span>{blog.readTime}</span>
                  </div>
                  <Link to={blog.link || '/blog'}>
                    <h3 className="font-bold text-sm text-[#1a1f1b] hover:text-[#062448] cursor-pointer transition-colors">
                      {blog.title}
                    </h3>
                  </Link>
      ...
      <section id="route-quote-form" className="py-16 px-4 md:px-12 max-w-4xl mx-auto border-t border-[#d8d0c3]">
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-xl border border-[#e2dacd]">
          ...
          {formStatus === 'success' ? (
            <div className="bg-[#EBF2F9] border border-[#062448]/30 rounded-2xl p-8 text-center space-y-4">
              <div className="w-14 h-14 rounded-full bg-[#062448] text-white flex items-center justify-center mx-auto">
              ...
              <div className="pt-2 flex justify-center gap-3">
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg bg-[#062448] text-white font-bold text-xs uppercase tracking-wider"
                >
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 font-['Manrope']">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[#d8d0c3] bg-[#fbf9f6] text-sm focus:outline-none focus:border-[#062448]"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-neutral-700 mb-1">
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-[#062448] text-white font-['Manrope'] font-bold text-sm uppercase tracking-wider shadow-lg hover:bg-[#0A3366] transition-all flex items-center justify-center gap-2"
              >
      ...
      <section className="py-16 px-4 md:px-12 bg-[#062448] text-white text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          <span className="text-xs font-bold font-['Space_Mono'] uppercase tracking-widest text-[#E9A015] bg-black/20 px-3 py-1 rounded-full">
          ...
          <div className="pt-4 flex flex-wrap gap-4 justify-center items-center">
            <button
              onClick={scrollToQuote}
              className="px-8 py-4 rounded-xl bg-[#E9A015] text-[#4A2E00] font-['Manrope'] font-extrabold text-sm uppercase tracking-wider shadow-lg hover:bg-[#D08C0A] transition-transform transform hover:-translate-y-0.5"
            >
              Book Truck Now
            </button>
            <a
              href="tel:+919784800833"
              className="px-7 py-4 rounded-xl bg-white text-[#062448] font-['Manrope'] font-bold text-sm uppercase tracking-wider hover:bg-neutral-100 transition-colors flex items-center gap-2 shadow-md"
            >
              <Phone size={18} />
              <span>Call: +91 97848 00833</span>
            </a>
