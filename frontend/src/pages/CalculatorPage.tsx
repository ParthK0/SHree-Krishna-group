    ...
    <div className="w-full min-h-screen bg-[#ECE6DD] text-[#1a1f1b] font-['Manrope'] pb-16">
      ...
      <section className="bg-neutral-900 text-white py-12 md:py-16 px-4 md:px-8 border-b border-[#3e4841] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#062448]/30 border border-[#062448]/60 text-[#85B7EB] font-['Space_Mono'] text-xs uppercase font-bold tracking-wider">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 pt-16 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-[#c5beb4] rounded-xl p-5 space-y-2 shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-[#EBF2F9] text-[#062448] flex items-center justify-center">
              <FileCheck size={20} />
            </div>
          ...
          <div className="bg-white border border-[#c5beb4] rounded-xl p-5 space-y-2 shadow-sm">
            <div className="w-10 h-10 rounded-lg bg-[#EBF2F9] text-[#E9A015] flex items-center justify-center">
              <ShieldCheck size={20} />
            </div>
            <h3 className="font-['Archivo_Narrow'] font-bold text-lg uppercase text-[#1a1f1b]">
        ...
        <div className="bg-white border border-[#c5beb4] rounded-2xl p-6 sm:p-8 space-y-6 shadow-sm">
          <div className="flex items-center gap-2 border-b border-[#e5ded5] pb-4">
            <HelpCircle size={22} className="text-[#062448]" />
          ...
          <div className="pt-4 border-t border-[#e5ded5] flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <Link
              to="/book-truck"
              className="inline-flex items-center gap-2 text-xs font-bold font-['Manrope'] text-[#062448] hover:text-[#0A3366] uppercase tracking-wider"
            >
