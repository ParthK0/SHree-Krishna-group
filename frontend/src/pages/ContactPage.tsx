      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="font-['Space_Mono'] text-xs text-[#5a665c]">
            <span>Home</span> / <span className="text-[#0B3A66] font-bold">Contact</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-[#c5beb4] rounded-2xl p-6 md:p-8 shadow-sm space-y-5">
            ...
            <a
              ...
              className="flex items-start gap-4 p-4 rounded-xl bg-[#f4f0ea] border border-[#e2dad0] hover:border-[#0B3A66] transition-colors group"
            >
              <div className="w-10 h-10 rounded-lg bg-[#EBF2F9] flex items-center justify-center text-[#0B3A66] shrink-0">
                <Phone size={18} />
              </div>
              <div>
            ...
            >
              ...
              <div>
                ...
                <div className="font-['Space_Mono'] text-sm font-bold text-[#1a1f1b] group-hover:text-[#0B3A66] transition-colors break-all">{CONTACT_EMAIL}</div>
              </div>
            </a>
        ...
        <div className="bg-white border border-[#c5beb4] rounded-2xl p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 font-['Manrope'] text-xs font-bold text-[#0B3A66] hover:underline shrink-0"
            >
