    ...
    <div className="w-full bg-[#ECE6DD] min-h-screen text-[#1a1f1b]">
          ...
          <div className="max-w-xl mx-auto pt-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white border border-[#d8d0c3] text-sm shadow-sm focus:outline-none focus:border-[#0B3A66] font-['Manrope']"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-12 max-w-7xl mx-auto">
        ...
        {!searchQuery && selectedCategory === 'all' && featuredPost && (
          <div className="mb-12 bg-white rounded-3xl p-6 md:p-10 border border-[#e2dacd] shadow-xl hover:border-[#0B3A66] transition-all grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              <div className="flex items-center gap-3">
                <span className="px-3 py-1 rounded-full bg-[#FFF9E6] text-[#071F35] text-xs font-bold font-['Space_Mono'] uppercase border border-[#F5B51B]/40">
              ...
              <Link to={`/blog/${featuredPost.slug}`}>
                <h2 className="text-2xl sm:text-3xl font-extrabold uppercase font-['Archivo_Narrow'] text-[#1a1f1b] hover:text-[#0B3A66] transition-colors leading-tight">
                  {featuredPost.title}
                </h2>
              </Link>
              ...
              <div className="space-y-1.5 pt-2">
                {featuredPost.keyTakeaways.slice(0, 3).map((item, idx) => (
                  <div key={idx} className="flex items-start gap-2 text-xs text-neutral-700 font-['Manrope']">
                    <span className="text-[#0B3A66] font-bold mt-0.5">•</span>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-4 flex items-center justify-between">
                <div className="flex items-center gap-2 text-xs text-neutral-500 font-['Manrope']">
                  <User size={14} className="text-[#0B3A66]" />
                ...
                <Link
                  ...
                  className="px-5 py-2.5 rounded-xl bg-[#0B3A66] hover:bg-[#0c532b] text-white text-xs font-bold font-['Manrope'] uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-sm"
                >
            ...
            >
              <div>
                ...
                <Link to={`/blog/${post.slug}`}>
                  <h3 className="text-lg font-bold uppercase font-['Archivo_Narrow'] text-[#1a1f1b] group-hover:text-[#0B3A66] transition-colors leading-snug mb-2.5">
                    {post.title}
                  </h3>
                </Link>
              ...
              <div className="pt-4 border-t border-[#ece6dd] flex items-center justify-between">
                ...
                <Link
                  to={`/blog/${post.slug}`}
                  className="text-xs font-bold text-[#0B3A66] hover:underline font-['Space_Mono'] flex items-center gap-1"
                >
        ...
        <div className="mt-16 bg-white rounded-3xl p-8 border border-[#e2dacd] shadow-md flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 text-xs font-bold text-[#0B3A66] font-['Space_Mono'] uppercase mb-1">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <a
              ...
              className="px-5 py-3 rounded-xl bg-[#0B3A66] hover:bg-[#0c532b] text-white text-xs font-bold font-['Manrope'] uppercase tracking-wider transition-colors flex items-center gap-2 shadow-sm"
            >
