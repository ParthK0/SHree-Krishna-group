      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="font-['Space_Mono'] text-xs text-[#5a665c]">
            Home / <span className="text-[#062448] font-bold">Terms & Conditions</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#c5beb4] rounded-2xl p-6 md:p-10 shadow-sm space-y-8">
          ...
          <Section title="1. About Shree Krishna Transport">
            <p>
              <strong>Shree Krishna Transport</strong> is a transportation service provider and freight facilitator based in Jaipur, Rajasthan (GSTIN: <span className="font-['Space_Mono'] font-bold text-[#062448]">{GSTIN}</span>). We connect customers with our network of independent transport partners to arrange transportation services across India. Unless expressly agreed otherwise in writing, Shree Krishna Transport does not own or operate the vehicles used for transportation.
            </p>
          ...
          <Section title="4. Lorry Receipt (LR) & Booking Reference">
            ...
            <p>
              <strong>Booking Reference ID:</strong> Shree Krishna Transport provides a unique Booking Reference ID (e.g., <code className="bg-[#f4f0ea] px-1.5 py-0.5 rounded font-['Space_Mono'] text-xs text-[#062448]">SKT-BK-12345</code>) for your request to facilitate direct tracking and communication with our dispatch desk.
            </p>
          </Section>
          ...
          <Section title="5. Vehicle Availability & Cancellation">
            ...
            <p>See our full <Link to="/cancellation-refund-policy" className="text-[#062448] underline font-bold">Cancellation & Refund Policy</Link> for details.</p>
          </Section>
          ...
          <Section title="11. Contact & Legal Details">
            ...
            <p><strong>GSTIN:</strong> <span className="font-['Space_Mono'] font-bold text-[#062448]">{GSTIN}</span></p>
