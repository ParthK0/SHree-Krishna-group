  ...
  return (
    <div className={`w-full max-w-5xl mx-auto bg-white border border-[#c5beb4] rounded-2xl shadow-xl overflow-hidden ${compact ? 'p-4 sm:p-6' : 'p-6 sm:p-8 md:p-10'}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e5ded5] pb-6">
        <div>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0B3A66]/10 text-[#0B3A66] font-['Space_Mono'] text-xs font-bold uppercase tracking-wider mb-2">
            <Calculator size={14} className="text-[#F5B51B]" />
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <label className="font-['Archivo_Narrow'] text-xs font-bold uppercase tracking-wider text-[#1a1f1b] flex items-center gap-1.5">
                <MapPin size={15} className="text-[#0B3A66]" />
                <span>Route Corridor</span>
              </label>
              <button
                type="button"
                onClick={handleSwapCities}
                className="text-xs text-[#0B3A66] hover:text-[#072D54] font-bold font-['Space_Mono'] underline flex items-center gap-1"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-[#c5beb4] bg-[#fdfcfb] font-['Manrope'] text-sm font-semibold text-[#1a1f1b] focus:outline-none focus:ring-2 focus:ring-[#0B3A66]"
                />
          ...
          {mode === 'truck' ? (
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl border cursor-pointer transition-all duration-150 flex items-center justify-between gap-3 ${isSelected
                          ? 'bg-[#EBF2F9] border-[#0B3A66] shadow-sm'
                    ...
                    >
                      ...
                      <div
                        className={`w-5 h-5 rounded-full border flex items-center justify-center shrink-0 ${isSelected ? 'border-[#0B3A66] bg-[#0B3A66] text-white' : 'border-[#c5beb4]'
                          }`}
                      >
            ...
            <div className="space-y-4 bg-[#f9f6f2] border border-[#e2dad0] rounded-xl p-5">
              <div className="flex items-center justify-between">
                <label className="font-['Archivo_Narrow'] text-xs font-bold uppercase tracking-wider text-[#1a1f1b] flex items-center gap-1.5">
                  <Package size={15} className="text-[#0B3A66]" />
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="w-20 px-2.5 py-1 text-center font-['Space_Mono'] font-bold text-base rounded-lg border border-[#c5beb4] bg-white text-[#0B3A66] focus:outline-none focus:ring-2 focus:ring-[#0B3A66]"
                  />
              ...
              <input
                ...
                className="w-full accent-[#0B3A66] cursor-pointer"
              />
              ...
              <div className="p-3 bg-white border border-[#e2dad0] rounded-lg text-xs text-[#3d4a3f] font-['Manrope'] flex items-start gap-2">
                <Info size={16} className="text-[#0B3A66] shrink-0 mt-0.5" />
                <p>
        ...
        <div className="lg:col-span-5">
          <div className="bg-[#181d19] text-white rounded-2xl p-6 sm:p-7 shadow-xl border border-neutral-800 flex flex-col justify-between h-full space-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="font-['Space_Mono'] text-3xl sm:text-4xl font-extrabold text-[#F5B51B] tracking-tight">
            ...
            <div className="space-y-2 text-xs font-['Manrope'] text-neutral-300">
              ...
              <div className="flex items-center gap-2">
                <ShieldCheck size={14} className="text-[#F5B51B] shrink-0" />
            ...
            <div className="pt-2 space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-[#F5B51B] hover:bg-[#E0A212] text-[#071F35] font-['Manrope'] font-extrabold text-sm py-4 px-6 rounded-xl shadow-lg transition-all duration-200 uppercase tracking-wider group"
              >
