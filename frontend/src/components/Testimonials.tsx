      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          <div className="bg-white border border-[#c5beb4] rounded-2xl p-4 shadow-sm flex items-center gap-4 shrink-0">
            <div className="w-12 h-12 rounded-xl bg-[#FFF8E1] border border-[#F4B400]/40 flex flex-col items-center justify-center">
              <span className="font-['Space_Mono'] text-lg font-bold text-[#b07d00] leading-none">4.9</span>
              <div className="flex text-[#F4B400] text-[9px] mt-0.5">
                {'★'.repeat(5)}
              </div>
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.id}
              className="bg-white border border-[#c5beb4] rounded-2xl p-6 sm:p-7 shadow-sm hover:shadow-md hover:border-[#0F6A37]/50 transition-all duration-300 flex flex-col justify-between relative group"
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-['Space_Mono'] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-[#FAF7F2] text-[#0F6A37] border border-[#e2dad0]">
                    {t.sector}
                  </span>
                </div>
                ...
                <div className="relative">
                  <Quote size={24} className="text-[#0F6A37]/15 absolute -top-2 -left-1 pointer-events-none" />
                  <p className="font-['Manrope'] text-xs sm:text-sm text-[#2E3630] leading-relaxed relative z-10 pl-4 border-l-2 border-[#0F6A37]">
                    "{t.review}"
                  </p>
                </div>
              ...
              <div className="pt-5 mt-5 border-t border-[#e5ebe7] flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-[9px] font-['Space_Mono'] font-bold text-[#0F6A37] bg-[#EBF5EE] px-2 py-1 rounded">
                    {t.loadType}
                  </span>
                </div>
              </div>
