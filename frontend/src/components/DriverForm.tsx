  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6 bg-[#f4f0ea] p-1.5 rounded-xl border border-[#e2dad0]">
        ...
        >
          <span className={`w-5 h-5 rounded-full text-[11px] flex items-center justify-center font-bold ${currentStep === 1 ? 'bg-white text-[#0B3A66]' : 'bg-[#e2dad0] text-[#5a665c]'}`}>
            1
          </span>
        ...
        >
          <span className={`w-5 h-5 rounded-full text-[11px] flex items-center justify-center font-bold ${currentStep === 2 ? 'bg-white text-[#0B3A66]' : 'bg-[#e2dad0] text-[#5a665c]'}`}>
            2
          </span>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {currentStep === 1 && (
          <div className="space-y-4 animate-fadeIn">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="driver_name" className={labelClass}>Full Name<span className="text-[#0B3A66] ml-0.5">*</span></label>
              ...
              <div>
                <label htmlFor="driver_phone" className={labelClass}>Mobile Number<span className="text-[#0B3A66] ml-0.5">*</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="driver_dlNumber" className={labelClass}>Driving Licence Number<span className="text-[#0B3A66] ml-0.5">*</span></label>
              ...
              <div>
                <label htmlFor="driver_vehicleNumber" className={labelClass}>Vehicle Number<span className="text-[#0B3A66] ml-0.5">*</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="driver_vehicleType" className={labelClass}>Vehicle Type<span className="text-[#0B3A66] ml-0.5">*</span></label>
              ...
              <div>
                <label htmlFor="driver_capacity" className={labelClass}>Capacity (in Tons)<span className="text-[#0B3A66] ml-0.5">*</span></label>
            ...
            {formData.vehicleType === 'Other' && (
              <div>
                <label htmlFor="driver_customVehicleType" className={labelClass}>Specify Vehicle Type<span className="text-[#0B3A66] ml-0.5">*</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="driver_location" className={labelClass}>Current Location<span className="text-[#0B3A66] ml-0.5">*</span></label>
              ...
              <div className="flex flex-col justify-end">
                <label className="flex items-center gap-2 text-xs font-['Manrope'] font-bold text-[#3d4a3f] cursor-pointer py-3">
                  <input
                    ...
                    className="w-4 h-4 rounded text-[#0B3A66] focus:ring-[#0B3A66]"
                  />
            ...
            {!formData.isOwner && (
              <div>
                <label htmlFor="driver_ownerName" className={labelClass}>Vehicle Owner Name<span className="text-[#0B3A66] ml-0.5">*</span></label>
        ...
        {currentStep === 2 && (
          <div className="space-y-4 animate-fadeIn">
            ...
            {submitted && (
              <div className="bg-[#EBF2F9] border border-[#0B3A66]/30 rounded-lg p-4 flex items-center gap-2 font-['Manrope'] text-xs font-bold text-[#0B3A66]">
            ...
            <label className="flex items-start gap-3 p-4 rounded-xl border border-[#e2dad0] bg-[#f9f6f2] cursor-pointer hover:border-[#0B3A66] transition-colors">
              <input
                type="checkbox"
                checked={declared}
                onChange={(e) => setDeclared(e.target.checked)}
                className="mt-0.5 w-4 h-4 rounded text-[#0B3A66] focus:ring-[#0B3A66] shrink-0"
              />
