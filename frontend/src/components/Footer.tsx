...
import {
  ...
  ADDRESS_PIN, BUSINESS_HOURS, SOCIAL_LINKS,
} from '../lib/constants';
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 py-6 md:py-7">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          ...
          <div className="space-y-2.5">
            ...
            <div className="pt-2">
              <div className="font-['Manrope'] text-[10px] font-semibold text-[#D9E4EE]/70 uppercase tracking-wider mb-1.5">
                Connect With Us
              </div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  aria-label="Follow Shree Krishna Transport on Instagram"
                  className="w-7 h-7 rounded-lg bg-[#0B3A66]/60 hover:bg-[#E1306C] text-[#D9E4EE] hover:text-white flex items-center justify-center transition-colors border border-[#0B3A66]"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Follow Shree Krishna Transport on Facebook"
                  className="w-7 h-7 rounded-lg bg-[#0B3A66]/60 hover:bg-[#1877F2] text-[#D9E4EE] hover:text-white flex items-center justify-center transition-colors border border-[#0B3A66]"
                >
                  <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Connect with Shree Krishna Transport on LinkedIn"
                  className="w-7 h-7 rounded-lg bg-[#0B3A66]/60 hover:bg-[#0A66C2] text-[#D9E4EE] hover:text-white flex items-center justify-center transition-colors border border-[#0B3A66]"
                >
                  <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Watch Shree Krishna Transport fleet on YouTube"
                  className="w-7 h-7 rounded-lg bg-[#0B3A66]/60 hover:bg-[#FF0000] text-[#D9E4EE] hover:text-white flex items-center justify-center transition-colors border border-[#0B3A66]"
                >
                  <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Message Shree Krishna Transport on WhatsApp"
                  className="w-7 h-7 rounded-lg bg-[#0B3A66]/60 hover:bg-[#25D366] text-[#D9E4EE] hover:text-white flex items-center justify-center transition-colors border border-[#0B3A66]"
                >
                  <svg className="w-3.5 h-3.5 fill-currentColor" viewBox="0 0 24 24">
