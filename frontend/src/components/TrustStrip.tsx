  ...
  return (
    <section className="bg-[#1C201D] border-y border-neutral-800 py-7 px-4 md:px-12">
      <div className="max-w-6xl mx-auto">
        <p className="font-['Manrope'] text-[10px] font-bold text-[#85B7EB] uppercase tracking-widest mb-4 text-center">
          Why Choose Shree Krishna Transport
        </p>
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-3">
          {trustItems.map((item) => (
            <div key={item} className="flex items-center gap-2 text-neutral-200">
              <CheckCircle2 size={15} className="text-[#E9A015] shrink-0" />
