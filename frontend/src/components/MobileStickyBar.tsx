  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-neutral-900/95 backdrop-blur-md border-t border-neutral-700/80 px-3 py-2.5 shadow-[0_-4px_20px_rgba(0,0,0,0.35)] safe-area-pb">
      <div className="grid grid-cols-2 gap-2 max-w-md mx-auto">
        ...
        <Link
          to="/book-truck"
          className="flex items-center justify-center gap-1.5 bg-[#E9A015] hover:bg-[#D08C0A] active:bg-[#c99500] text-[#4A2E00] font-['Manrope'] font-extrabold text-xs py-3 px-2 rounded-xl shadow transition-colors uppercase tracking-wider"
          aria-label="Request 1-Hour WhatsApp Freight Quote"
        >
          <Truck size={16} className="text-[#4A2E00] shrink-0" />
