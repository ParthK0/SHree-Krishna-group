  ...
  useEffect(() => {
    ...
    const jaipurHtml = `
      <div class="relative flex items-center justify-center -translate-x-1/2 -translate-y-1/2 cursor-pointer group pointer-events-auto">
        ...
        <span class="absolute w-10 h-10 rounded-full bg-[#0F6A37]/50 border border-[#F4B400] animate-pulse"></span>
        <div class="w-8 h-8 rounded-full bg-[#0F6A37] border-2 border-[#F4B400] text-white flex items-center justify-center shadow-2xl font-black text-[10px] font-mono">
          RJ14
        </div>
        <div class="absolute -top-7 whitespace-nowrap px-2.5 py-0.5 rounded-full bg-[#0b100c]/90 border border-[#F4B400] text-[#F4B400] text-[9.5px] font-extrabold font-mono shadow-xl flex items-center gap-1.5">
    ...
    DELIVERY_CITIES.forEach((city) => {
      ...
      const cityHtml = `
        <div class="relative flex items-center -translate-x-1/2 -translate-y-1/2 cursor-pointer group pointer-events-auto">
          ${isSelected ? '<span class="absolute -inset-2 rounded-full bg-[#F4B400] opacity-40 animate-ping"></span>' : ''}
          <div class="w-3.5 h-3.5 rounded-full ${
            isSelected
              ? 'bg-[#F4B400] ring-2 ring-white scale-125'
              : 'bg-[#38bdf8] border border-white/60 hover:bg-[#F4B400]'
          } shadow-md transition-all"></div>
          <div class="ml-2 px-2 py-0.5 rounded-md ${
            isSelected
              ? 'bg-[#0F6A37] text-white border border-[#F4B400]'
              : 'bg-black/85 text-neutral-200 border border-white/20 group-hover:border-[#F4B400]'
          } text-[11px] font-bold font-sans whitespace-nowrap shadow-lg flex items-center gap-1.5 transition-all">
            <span>${city.name}</span>
            ${isSelected ? `<span class="text-[9px] font-mono text-[#F4B400] font-extrabold">(${city.rateRange})</span>` : ''}
          </div>
        </div>
      `;
        ...
        <div className="mb-10 bg-[#141815] text-white rounded-3xl p-5 sm:p-7 md:p-8 border border-neutral-800 shadow-2xl overflow-hidden relative">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-5 relative z-10">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="px-2 py-0.5 rounded-full bg-[#0F6A37]/30 border border-[#0F6A37]/50 text-[#8ad7a0] text-[10px] font-['Space_Mono'] font-bold">
                  RJ-14 ORIGIN HUB
                </span>
              </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-5 bg-white/5 p-2 rounded-2xl border border-white/5">
            <div className="flex flex-wrap items-center gap-1.5">
              <span className="text-[11px] font-bold text-neutral-400 font-['Space_Mono'] uppercase px-2 flex items-center gap-1">
                <Filter size={12} className="text-[#F4B400]" />
                Region:
              </span>
              {[
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1 rounded-xl text-xs font-['Space_Mono'] transition-all ${
                      isActive
                        ? 'bg-[#F4B400] text-[#111512] font-bold shadow-md'
            ...
            <div className="flex items-center gap-2 px-2">
              ...
              >
                <Radio size={12} className={showAllCorridors ? 'text-[#F4B400]' : 'text-neutral-500'} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
            ...
            <div className="lg:col-span-7 relative w-full h-[460px] sm:h-[520px] md:h-[560px] rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-[#101411]">
              ...
              <div className="absolute top-3 left-3 z-[400] flex items-center gap-2 bg-black/85 px-3 py-1.5 rounded-xl border border-white/15 backdrop-blur-md text-[10px] font-['Space_Mono'] text-neutral-200 shadow-xl">
                ...
                <span className="text-[#F4B400] font-extrabold">LIVE TELEMETRY:</span>
              ...
              <div className="absolute top-3 right-3 z-[400] flex flex-col gap-1.5 bg-black/85 p-1 rounded-xl border border-white/15 backdrop-blur-md shadow-2xl">
                ...
                <button
                  ...
                  className="w-7 h-7 rounded-lg bg-[#0F6A37] hover:bg-[#138043] text-[#F4B400] flex items-center justify-center transition-colors"
              ...
              <div className="absolute bottom-2.5 left-2.5 right-2.5 z-[400] flex flex-wrap items-center justify-between gap-2 text-[10px] text-neutral-300 font-['Space_Mono'] px-3 py-1.5 bg-black/85 rounded-xl backdrop-blur-md border border-white/15 shadow-xl">
                ...
                <span className="text-[#8ad7a0] font-bold">
            ...
            <div className="lg:col-span-5 bg-[#121613] rounded-2xl border border-neutral-800 p-4 sm:p-5 flex flex-col justify-between shadow-2xl">
              <div>
                ...
                <div className="flex items-center justify-between gap-2 mb-3 pb-3 border-b border-white/10">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold uppercase tracking-wider text-[#F4B400] font-['Space_Mono']">
                ...
                <div className="bg-black/50 rounded-xl p-3.5 border border-white/10 mb-4">
                  <div className="flex items-center justify-between text-[11px] font-['Space_Mono'] text-neutral-400 mb-1.5">
                    <span className="text-[#8ad7a0] font-bold flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-[#0F6A37] border border-[#F4B400]" />
                      ORIGIN (RJ-14)
                    </span>
                  ...
                  <div className="flex items-center justify-between gap-2 font-['Archivo_Narrow'] font-extrabold text-lg sm:text-xl">
                    ...
                    <div className="flex-1 flex items-center justify-center px-2">
                      <div className="h-[2px] w-full bg-gradient-to-r from-[#0F6A37] via-[#F4B400] to-[#38bdf8] relative">
                        <Truck
                          size={15}
                    ...
                    <div className="text-[#F4B400]">{activeCity.name}</div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2.5 mb-4">
                  ...
                  <div className="bg-white/5 p-3 rounded-xl border border-white/5">
                    ...
                    <span className="text-sm sm:text-base font-extrabold font-['Space_Mono'] text-[#F4B400] block mt-0.5">
                  ...
                  <div className="bg-white/5 p-3 rounded-xl border border-white/5">
                    ...
                    <span className="text-sm font-bold font-['Space_Mono'] text-[#8ad7a0] block mt-0.5">
                      Daily Scheduled
                    </span>
                    <span className="text-[10px] text-neutral-400 font-['Manrope'] block mt-0.5">
              ...
              <div className="space-y-2 pt-2 border-t border-white/10">
                <a
                  ...
                  className="w-full py-2.5 px-4 rounded-xl bg-[#0F6A37] hover:bg-[#138043] text-white font-bold font-['Manrope'] text-xs sm:text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-[#0F6A37]/30"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Phone size={13} className="text-[#F4B400]" />
          ...
          <div className="mt-5 pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 text-xs font-['Space_Mono'] text-neutral-300">
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2">
                <span className="w-4 h-4 rounded-full bg-[#0F6A37] border-2 border-[#F4B400] flex items-center justify-center text-[7px] font-bold text-white">
                  RJ
                </span>
              ...
              <div className="flex items-center gap-2">
                <div className="w-5 h-[2px] bg-gradient-to-r from-[#0F6A37] to-[#F4B400]" />
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
          <button
            ...
            className={`px-5 py-3 rounded-2xl font-['Archivo_Narrow'] font-bold text-xs sm:text-sm md:text-base uppercase tracking-wider transition-all flex items-center gap-2 shadow-sm ${
              activeTab === 'delhi'
                ? 'bg-[#0F6A37] text-white shadow-[#0F6A37]/25 ring-2 ring-[#0F6A37]/30'
                    ...
                    filteredPanIndia.map((item) => (
                      <tr key={item.sNo} className="hover:bg-[#fbf9f6] transition-colors group">
                        ...
                        <td className="py-3.5 px-4">
                          <span className="inline-block px-3 py-1 rounded-xl bg-[#EBF5EE] text-[#0F6A37] font-['Space_Mono'] font-extrabold text-sm border border-[#0F6A37]/20">
                            {item.rateRange}
                          </span>
                        </td>
                        ...
                        <td className="py-3.5 px-4 text-right font-extrabold text-[#0F6A37] font-['Space_Mono'] text-xs sm:text-sm">
        ...
        {activeTab === 'parcel' && (
          <div className="bg-white rounded-3xl p-6 md:p-10 border border-[#e2dacd] shadow-xl animate-fadeIn">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-6 border-b border-[#e2dacd] mb-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FFF9E6] text-[#8a6500] font-['Space_Mono'] text-xs font-bold border border-[#F4B400]/30">
                <Sparkles size={14} className="text-[#F4B400]" />
                  ...
                  {PARCEL_COURIER_FREIGHT_RATES.map((item) => (
                    <tr key={item.sNo} className="hover:bg-[#fbf9f6] transition-colors group">
                      ...
                      <td className="py-4 px-4 text-xs font-['Space_Mono']">
                        <span className="px-2.5 py-1 rounded-full bg-[#EBF5EE] text-[#0F6A37] font-bold">
                          {item.badge}
                        </span>
                      </td>
                      <td className="py-4 px-4 text-xs text-neutral-600 max-w-sm">{item.idealFor}</td>
                      <td className="py-4 px-4 text-right">
                        <span className="font-extrabold text-[#0F6A37] font-['Space_Mono'] text-base sm:text-lg whitespace-nowrap">
                          {item.rate}
                        </span>
                      </td>
                      <td className="py-4 px-4 text-center">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#0F6A37] hover:bg-[#0c532b] text-white text-xs font-bold font-['Manrope'] transition-all shadow-sm"
                        >
                          <MessageCircle size={13} />
