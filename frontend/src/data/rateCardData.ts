...
export const RATE_CARD_META = {
  headline: 'Shree Krishna Transport Official Freight Rate Cards',
  subheadline: 'Transparent, Direct-to-Carrier Pricing with Zero Brokerage',
  phone: '9784800833',
  ...
  termsNote:
    'Rates are indicative and may vary based on exact loading location, material type, market conditions and other factors.',
  features: [
    { title: 'Safe and On-Time Delivery', desc: 'Guaranteed timely dispatch with verified drivers.' },
    { title: 'Verified Transport Network', desc: 'Pre-inspected trucks and certified fleet operators.' },
    { title: 'Experienced Drivers', desc: 'Vetted commercial pilots with comprehensive route knowledge.' },
    { title: 'Quotation in 1 Hr on WhatsApp', desc: 'Fast, customized, all-inclusive rates sent directly to your phone.' },
  ],
  services: [
